...
f:SetScript("OnEvent", function()
	...
	SetCVar("NamePlateHorizontalScale", 1.2)		-- Applied to horizontal size of all nameplates; default: 1.0
	SetCVar("NamePlateVerticalScale", 1.6)		-- Applied to vertical size of all nameplates; default: 1.0
	-- See also the values in "_nameplates\core.lua"
