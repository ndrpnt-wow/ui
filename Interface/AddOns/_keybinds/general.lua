-- Template (command = nil to unbind): success = SetBinding("key" [, "command"])

-- bind in sidebar: eat/drink (*4 so it covers mage food), flymout, groundmount, professions, potion1, potion2 (so it covers mana and herloom neck),S

-- bind in keybind menu: tabtarget, all panels, chat fuctions, mouvment keys,

-- bind in common file (because it require a macro): /m, 

-- only shown in side bar: hs, ghs, dalaranhs, other tps

-- bind nameplate: juste besoin de bind toggle friendly nameplates

-- GLOBE (townlong): slash command: bind certaines commandes (reload, fstack, eventtrace, quit, disconnect, macros, etc)
...
local general = {
	...
	["TARGETNEARESTFRIEND"] = "SHIFT-TAB",
	["TARGETNEARESTENEMYPLAYER"] = "ALT-TAB", -- LOLOLOLOL
	["TARGETNEARESTFRIENDPLAYER"] = "CTRL-TAB",
}
-- loop through this table in core, after calling UnbindAll.
