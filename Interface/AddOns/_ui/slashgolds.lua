...
SlashCmdList.GOLDS = function(msg)
	msg = string.upper(string.gsub(msg, "%s+", ""))
	if msg == "TOTAL" or msg == "ALL" then
		displayTotalmMoney()
    else
        displaysRealmMoney(type(goldsDB[msg]) == "table" and msg or formatedRealmName)
	end
end
SLASH_GOLDS1 = "/golds"
